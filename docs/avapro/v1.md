...
## 3. AvaPro_v1 Visualization

<p class="section-updated">Last updated: 24 Jul 2026</p>

MAIN does not write season overview plots (plotting in `MAIN_ava_prob_seasons.py` is commented out). Visualisation is done in Jupyter notebooks under `figure_notebooks/`, which load the pickle outputs (`df_P_*`, `df_met_*`, `*_avaprobs_.pkl`) from `output/`.

<div class="note-box">
<p class="note-box__title">Figure Notebooks</p>
<div class="note-box__body">
<a href="file:///Users/machtl/Documents/Projects_PhD/avapro_jul26/figure_notebooks">/Users/machtl/Documents/Projects_PhD/avapro_jul26/figure_notebooks</a>
</div>
</div>

When pointing notebooks at the ISSW26 NWP runs, update:

- paths to the new pickle folders under [`output/2026/NWP_stations/`](file:///Users/machtl/Documents/Projects_PhD/avapro_jul26/output/2026/NWP_stations)
- aspect lists if using 8 aspects (many notebooks still assume N/E/S/W only)
- icon assets under `input/icon_aspects/` (currently N/E/S/W/flat)
